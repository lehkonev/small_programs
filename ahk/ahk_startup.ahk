...
global wanted_keyboards := {"FI_fi21": -255720437, "EN_fi21": -255719415}
...
; The underscore is needed or digits are not recognised.
...
<!<^SC07D::
  ...
  if (ErrorLevel = "Timeout") { ; This should not happen because the restriction is not set.
	...
	; This has to be commented out because it always catches.
